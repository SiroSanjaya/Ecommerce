...
<body>
    ...
    <ol role="list" class="mx-auto flex max-w-2xl items-center space-x-2 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        <li>
            <div class="flex items-center">
                <a href="/CategoryProduct/<?= $category['category_id']; ?>" class="mr-2 text-sm font-medium text-gray-900"><?= $category['category_name']; ?></a>
                <svg width="16" height="20" viewBox="0 0 16 20" fill="currentColor" aria-hidden="true" class="h-5 w-4 text-gray-300">
                    <path d="M5.697 4.34L8.98 16.532h1.327L7.025 4.341H5.697z" />
                </svg>
            </div>
        ...
        <li class="text-sm">
            ...
            <div class="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8 lg:px-8">
                <?php foreach ($product_images as $image): ?>
                    <img src="<?= $image['photo_url']; ?>" alt="test" class="hidden size-full rounded-lg object-cover lg:block">
                <?php endforeach; ?>
            </div>
      ...
      <div class="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
        ...
        <div class="mt-10">
          ...
          <div class="mt-4">
            <ul role="list" class="list-disc space-y-2 pl-4 text-sm">
              <li class="text-gray-400"><span class="text-gray-600"><?= $product_detail['highlight']; ?></span></li>
            </ul>
          </div>
        </div>
        ...
        <div class="mt-10">
          ...
          <div class="mt-4 space-y-6">
            <p class="text-sm text-gray-600"><?= $product_detail['detail']; ?></p>
          </div>
        </div>
      </div>
    </div>
